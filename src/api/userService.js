...
export const getBookings = () => api.get("appUser/getBookings");
...
export const getNotifications = () => api.get("appUser/notifications");

export const getUnreadCount = () => api.get("appUser/notifications/unreadCount");

export const markNotificationRead = (notificationId) =>
  api.patch(`appUser/notifications/${notificationId}/read`);

export const markAllNotificationsRead = () =>
  api.patch("appUser/notifications/markAllRead");
